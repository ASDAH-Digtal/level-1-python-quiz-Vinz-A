...
# Finalise score
if str(score) == "12":
    print("{}/12 Correct, You are Amazing, You really know your things".format(str(score)))

elif score >= 7 and score < 12:
    print("{}/12 Correct, You did well, Hopefully you get a perfect score next time".format(str(score)))

else:
    print("{}/12 Correct, Good Try, Hopefully you do better next time".format(str(score)))